...
public class WeltDerBuntenFlummis extends LWJGLBasisFenster {
   ...
   private void erzeugeFlummies(int anz) {
      ...
      for (int i = 0; i < anz; i++) {
         flummis.registriereFlummi(new Flummi(rand.nextInt(WIDTH), rand.nextInt(HEIGHT), rand.nextFloat() + 1,
   ...
   public static void main(String[] args) {
      new WeltDerBuntenFlummis(
            "vividus Verlag. Dino-Buch. Kap. 1 (particle_version03_objectmanager): WeltDerBuntenFlummis.java", 800, 450)
                  .start();
   }
}
