...
public class Pyramide extends LWJGLBasisFensterEigenesCanvas {
	public Pyramide() {
		super("Pyramide dreht sich", 600, 600);
	}
	...
	public void renderLoop() {
		...
		while (!Display.isCloseRequested()) {
			...
			glColor3d(0, 0, 0);
			// POGL.renderPyramide(); // Lösung aus dem Buch
			POGL.renderPyramide2(); // Lösung von Dustin Heyer
