...
public class Kugel extends LWJGLBasisFensterEigenesCanvas {
	public Kugel() {
		super("Kugel dreht sich", 600, 600);
	}
	...
	public void renderLoop() {
		...
		while (!Display.isCloseRequested()) {
			...
			glColor3d(0, 0, 0);
			POGL.renderKugel(1.0f, 10, 10); // Lösung aus dem Buch
			//POGL.renderKugel2();// Lösung von Dustin Heyer
