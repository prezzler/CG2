...
public class WuerfelProjektionInSchwingendeFlaeche extends LWJGLBasisFenster {
   public WuerfelProjektionInSchwingendeFlaeche(String title, int width, int height) {
   ...
   public static void main(String[] args) {
      new WuerfelProjektionInSchwingendeFlaeche("vividus Verlag. Dino-Buch. Kap. 1: WuerfelProjektionInSchwingendeFlaeche.java", 500, 500).start();
   }
}
