...
public class Partikel extends BewegendesObjekt {
   ...
   public Partikel(Vektor2D position, Vektor2D velocity) {
      this(position, velocity, 20.0f, 0.05f, 0.39f, 0.51f);
   }
   
   public Partikel(Vektor2D position, Vektor2D velocity, float radius, float r, float g, float b) {
