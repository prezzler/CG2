...
public class MondReflexion extends LWJGLBasisFenster {
	...
	public static String fragShaderWaterDynamicVisualisation = "" 
		...
		+ ""
		+ "	  gl_FragColor			= texture2D(texT, 5.0 * reflectVector.xy + vec2(0.5, 0.5));" 
		+ "}";
	...
	public MondReflexion(String title, int width, int height) {
	...
	public void prepareMondTexture() {
		File file3 = new File("images/mond.jpg");  
		final int WU3 	= 322;
		final int HU3 	= 297;			
	...
	public static void main(String[] args) throws LWJGLException {
		new MondReflexion("vividus Verlag. Dino-Buch. Kapitel 2: MondReflexion.java", 800, 450).start();
	}
}
