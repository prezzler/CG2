...
public class GeometrieUndWasserdynamik extends LWJGLBasisFenster {
	...
	public static String vertShaderWaterdynamicAndMesh = "" 
		+ "#version 130\n"
		+ ""
	...
	public static String fragShaderWaterdynamicAndMesh = "" 
		+ "#version 130\n"
		+ ""
		+ "in vec4 frontColor;" 
		+ "" 
	...
	private int programWaterdynamic, programWaterdynamivGeometryVisualisation;
	private int uniform_programWaterdynamic_s, uniform_programWaterdynamic_tex1;
	private int uniform_programWaterdynamic_tex2;
	private int uniform_programWaterdynamivGeometryVisualisation_s;
	private int uniform_programWaterdynamivGeometryVisualisation_scale;
	private int uniform_programWaterdynamivGeometryVisualisation_tex;
	
	public GeometrieUndWasserdynamik(String title, int width, int height) {
	...
	public void prepareShaderWaterEffect() {
		...
		uniform_programWaterdynamic_s = glGetUniformLocation(programWaterdynamic, "s");
		uniform_programWaterdynamic_tex1 = glGetUniformLocation(programWaterdynamic, "tex1");
		uniform_programWaterdynamic_tex2 = glGetUniformLocation(programWaterdynamic, "tex2");
		glUseProgram(programWaterdynamic);
		
		glUniform2f(uniform_programWaterdynamic_s, 1.0f / WB, 1.0f / HB);
		glUniform1i(uniform_programWaterdynamic_tex1, 1);
		glUniform1i(uniform_programWaterdynamic_tex2, 0);
		
		ShaderUtilities.testShaderProgram(programWaterdynamic);
	}
	
	public void prepareShaderGeometrieUndVisualisierung() {
		programWaterdynamivGeometryVisualisation = glCreateProgram();

		int vertShader = glCreateShader(GL_VERTEX_SHADER);
		glShaderSource(vertShader, vertShaderWaterdynamicAndMesh);
		glCompileShader(vertShader);
		System.out.println(glGetShaderInfoLog(vertShader, 1024));
		glAttachShader(programWaterdynamivGeometryVisualisation, vertShader);
		
		int fragShader = glCreateShader(GL_FRAGMENT_SHADER);
		glShaderSource(fragShader, fragShaderWaterdynamicAndMesh);
		glCompileShader(fragShader);
		System.out.println(glGetShaderInfoLog(fragShader, 1024));
		glAttachShader(programWaterdynamivGeometryVisualisation, fragShader);

		glLinkProgram(programWaterdynamivGeometryVisualisation);
		uniform_programWaterdynamivGeometryVisualisation_s 		= glGetUniformLocation(programWaterdynamivGeometryVisualisation, "s");
		uniform_programWaterdynamivGeometryVisualisation_scale 	= glGetUniformLocation(programWaterdynamivGeometryVisualisation, "scale");
		uniform_programWaterdynamivGeometryVisualisation_tex 	= glGetUniformLocation(programWaterdynamivGeometryVisualisation, "tex");
		
		glUseProgram(programWaterdynamivGeometryVisualisation);
		
		glUniform4f(uniform_programWaterdynamivGeometryVisualisation_s, 1.0f/WB, 1.0f/HB, 1.0f, 1.0f);
		glUniform1f(uniform_programWaterdynamivGeometryVisualisation_scale, -40.0f);
		glUniform1i(uniform_programWaterdynamivGeometryVisualisation_tex, 0);
		
		ShaderUtilities.testShaderProgram(programWaterdynamivGeometryVisualisation);
	}
	...
	public void renderLoop() {
		...
		prepareShaderGeometrieUndVisualisierung();
	...
	public static void main(String[] args) throws LWJGLException {
		new GeometrieUndWasserdynamik("vividus Verlag. Dino-Buch. Kapitel 2: GeometrieUndWasserdynamik.java", 800, 450).start();
	}
}
