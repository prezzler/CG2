...
public class QuadGelb extends LWJGLBasisFenster {
	...
	public QuadGelb(String title, int width, int height) {
	...
	public static void main(String[] args) throws Exception {
		new QuadGelb("vividus Verlag. Dino-Buch. Kapitel 2: QuadGelb.java", 800, 450).start();
	}
}
