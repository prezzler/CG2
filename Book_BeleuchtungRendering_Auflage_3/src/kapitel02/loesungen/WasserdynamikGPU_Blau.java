...
public class WasserdynamikGPU_Blau extends LWJGLBasisFenster {
	...
	public static String fragShaderWaterDynamicVisualisation = ""
			...
			+ "" 
			+ "void main (void)" + "{"
			+ "	  vec4 col = (5.0*texture2D(tex1, gl_TexCoord[0].st) + vec4(1, 1, 1, 0))*0.5 * vec4(0, 0, 1, 1);"
			+ "	  gl_FragColor = col;" 
			+ "}";
	...
	public WasserdynamikGPU_Blau(String title, int width, int height) {
	...
	public static void main(String[] args) throws LWJGLException {
		new WasserdynamikGPU_Blau("vividus Verlag. Dino-Buch. Kapitel 2: WasserdynamikGPU_Blau.java", 800, 450).start();
	}
}
